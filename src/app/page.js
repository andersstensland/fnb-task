    ...
    <div className="flex flex-col justify-between h-full">
      <div className="p-4">
        ...
        <p className="mb-4 text-md">
          ...
          everyday. Payment on delivery. We only accept credit card payments for
          this service. A room service fee (50DKK) will be added to your order.
        </p>
        <div className="p-4 bg-gray-200 flex flex-row gap-2">
          ...
          <p className="font-bold text-md">
            ...
            delivery if proof of age is not provided to the crew upon delivery.
          </p>
        </div>
      </div>
      <div className="p-4">
